...
class BreakingNewsFragment : Fragment(R.layout.fragment_breaking_news){
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        newsAdapter.setOnItemClickListenerForNewsAdapter {
            println("news Adapter item clicked ${it.title}")
    ...
    private fun hideProgressBar(){
        paginationProgressBar_breaking.visibility = View.INVISIBLE
        isLoading = false

    }
    private fun showProgressBar(){
        paginationProgressBar_breaking.visibility = View.VISIBLE
        isLoading = true
    }
